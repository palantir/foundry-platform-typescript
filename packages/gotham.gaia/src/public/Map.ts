...
const _addArtifactsTo: $FoundryPlatformMethod<
  (
...
export function addArtifactsTo(
  ...
  return $foundryPlatformFetch($ctx, _addArtifactsTo, ...args);
}
...
const _loadWithExtension: $FoundryPlatformMethod<
  (
    mapRid: _Gaia.GaiaMapRid,
...
export function loadWithExtension(
  ...
  return $foundryPlatformFetch($ctx, _loadWithExtension, ...args);
}

const _loadLayers: $FoundryPlatformMethod<
  (
    mapRid: _Gaia.GaiaMapRid,
...
export function loadLayers(
  ...
  return $foundryPlatformFetch($ctx, _loadLayers, ...args);
}
