...
const _deleteTargetBoard: $FoundryPlatformMethod<
  (
...
export function deleteTargetBoard(
  ...
  return $foundryPlatformFetch($ctx, _deleteTargetBoard, ...args);
}

const _modify: $FoundryPlatformMethod<
  (
    targetBoardRid: _TargetWorkbench.TargetBoardRid,
...
export function modify(
  ...
  return $foundryPlatformFetch($ctx, _modify, ...args);
}
