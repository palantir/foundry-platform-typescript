...
import type * as _Orchestrator from "../_components.js";

//

const _complete: $FoundryPlatformMethod<
  (
 ...
 * URL: /v3/platform/processExecutions/{processExecutionId}/signals/{signalId}/complete
 */
