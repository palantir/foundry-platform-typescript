...
/**
   * The event that gets published to Appkit channels to update a users activity feed as new events
...
/**
   * The event that gets published to Appkit channels to update a users activity feed whenever an event
